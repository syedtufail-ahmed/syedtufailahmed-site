        ...
        <div className="container">
          ...
          <section className="credential-card influence-card">
            ...
            <p className="credential-description">
              Independent creator influence ranking based on content quality,
              engagement, domain authority, and network impact across LinkedIn
            ...
            <div className="membership-card">
              ...
              <div className="membership-content">
                ...
                <p className="membership-description">
                  Recognized member of the world’s leading professional
                  association for project, program, and portfolio management,
                  committed to PMI’s Code of Ethics and Professional Conduct.
                </p>
