...
export default function PersonSchema() {
  const schema = {
    ...
    "memberOf": [
      {
        "@type": "Organization",
        "name": "Global Council for Responsible AI (GCRAI)",
        "roleName": "Global Ambassador, Saudi Arabia"
      },
      {
        "@type": "Organization",
        "name": "Responsible AI Governance Network (RAGN)",
        "roleName": "Global Ambassador, Saudi Arabia"
      }
    ],
    "alumniOf": [
